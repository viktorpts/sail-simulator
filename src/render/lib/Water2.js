...
var Water = function ( geometry, options ) {
	...
	var normalMap0 = options.normalMap0 || textureLoader.load( 'water/Water_1_M_Normal.jpg' );
	var normalMap1 = options.normalMap1 || textureLoader.load( 'water/Water_2_M_Normal.jpg' );
...
Water.WaterShader = {
	...
	fragmentShader: [
        ...
        '	vec3 adjustedEye = vec3(toEye.x, toEye.z, toEye.y);',   // This is needed when the WCS is Z-up
